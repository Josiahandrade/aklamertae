...
$featured_posts_content_type = get_theme_mod( 'valid_news_featured_posts_content_type', 'post' );
$grid_posts_content_type     = get_theme_mod( 'fact_news_grid_posts_content_type', 'post' );
...
if ( $featured_posts_content_type === 'post' ) {
	...
	for ( $i = 1; $i <= 2; $i++ ) {
		$featured_posts_content_ids[] = get_theme_mod( 'valid_news_featured_posts_post_' . $i );
	}
	...
	$cat_content_id      = get_theme_mod( 'valid_news_featured_posts_category' );
	$featured_posts_args = array(
		'cat'            => $cat_content_id,
		'posts_per_page' => absint( 2 ),
	);
					...
					<div class="post-tabs-head">
						<ul class="post-tabs">
							<?php if ( $latest_news_enable === true ) : ?>
								<li><a href="#tab-1" class="latest"><i class="far fa-clock"></i><?php echo esc_html( 'Latest News', 'fact-news' ); ?></a></li>
							<?php endif; ?>
							<?php if ( $random_news_enable === true ) : ?>
								<li><a href="#tab-3" class="latest"><i class="fas fa-random"></i><?php echo esc_html( 'Random News', 'fact-news' ); ?></a></li>
							<?php endif; ?>
						</ul>
					</div>
