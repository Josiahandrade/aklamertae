	...
	class Fact_News_Featured_Posts_Widget extends WP_Widget {
		...
		public function __construct() {
			$featured_posts_widget = array(
				'classname'   => 'widget adore-widget featured-widget style-3',
				'description' => __( 'Retrive Featured Posts Widgets', 'valid-news' ),
			);
			parent::__construct(
				'fact_news_featured_posts_widget',
				__( 'Fact News: Featured Posts Widget', 'valid-news' ),
