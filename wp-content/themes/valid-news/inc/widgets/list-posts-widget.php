<?php
if ( ! class_exists( 'Valid_News_List_Posts_Widget' ) ) {
	/**
	 * Adds Valid News List Posts Widget.
	 */
	class Valid_News_List_Posts_Widget extends WP_Widget {
		...
		public function __construct() {
			$list_posts_widget = array(
				...
				'description' => __( 'Retrive List Posts Widgets', 'valid-news' ),
			);
			parent::__construct(
				'fact_news_list_posts_widget',
				__( 'Fact News: List Posts Widget', 'valid-news' ),
				$list_posts_widget
			);
		}
		...
		public function widget( $args, $instance ) {
			...
			$read_more_button_label = ( ! empty( $instance['read_more_button_label'] ) ) ? $instance['read_more_button_label'] : __( 'Read More', 'valid-news' );
		...
		public function form( $instance ) {
			...
			$read_more_button_label = isset( $instance['read_more_button_label'] ) ? $instance['read_more_button_label'] : __( 'Read More', 'valid-news' );
			$list_posts_post_offset = isset( $instance['offset'] ) ? absint( $instance['offset'] ) : '';
			$list_posts_category    = isset( $instance['category'] ) ? absint( $instance['category'] ) : '';
			?>
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Section Title:', 'valid-news' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'view_all_button_label' ) ); ?>"><?php esc_html_e( 'View All Button:', 'valid-news' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'view_all_button_link' ) ); ?>"><?php esc_html_e( 'View All Button URL:', 'valid-news' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'read_more_button_label' ) ); ?>"><?php esc_html_e( 'Read More Button Label:', 'valid-news' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'offset' ) ); ?>"><?php esc_html_e( 'Number of posts to displace or pass over:', 'valid-news' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'category' ) ); ?>"><?php esc_html_e( 'Select the category to show posts:', 'valid-news' ); ?></label>
