...
<body <?php body_class(); ?>>
	...
	<div id="page" class="site">
		<a class="skip-link screen-reader-text" href="#primary-content"><?php esc_html_e( 'Skip to content', 'valid-news' ); ?></a>
		...
		<header id="masthead" class="site-header">
			...
			<?php
			$header_adver_image     = get_theme_mod( 'valid_news_advertisement_image', '' );
			$header_adver_image_url = get_theme_mod( 'valid_news_advertisement_url', '#' );
								...
								<div class="display-random-post">
									...
									if ( $random_query->have_posts() ) {
										while ( $random_query->have_posts() ) :
											...
											?>
											<a href="<?php the_permalink(); ?>" title="<?php esc_attr_e( 'View Random Post', 'valid-news' ); ?>">
